...
local Window = OrionLib:MakeWindow({Name = "Erik Hub V2", HidePremium = false,IntroText = "Erik Library", SaveConfig = true, ConfigFolder = "Erik Hub V2"})
...
I:AddLabel("Owner Name : Luu Gia Bao (ERIK)")
I:AddLabel("BirthDay : 0909/2016")
I:AddLabel("My Discord : https://discord.gg/y9ZDzhYxdx")
